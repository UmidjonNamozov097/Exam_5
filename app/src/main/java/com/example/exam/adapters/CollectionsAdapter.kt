...
import com.example.exam.models.Collections

class CollectionsAdapter(var contacts:ArrayList<Collections>):
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        var view=
            LayoutInflater.from(parent.context).inflate(R.layout.item_feed_collections,parent,false)
